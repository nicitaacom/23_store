...
// deviceId (see `deviceId.ts`), never the signed id itself.
type DeviceIdStore = {
...
export const useDeviceIdStore = create<DeviceIdStore>()(devtools(persist(set => deviceIdStore(set), { name: "deviceIdStore" })))
