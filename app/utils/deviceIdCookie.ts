 ...
 */
export const DEVICE_ID_COOKIE_NAME: TCookieName = "23_did"
...
export function decryptDeviceId(cookieValue: string | undefined): string | null {
  ...
  try {
    ...
    return Buffer.concat([decipher.update(packed.subarray(IV_LENGTH + AUTH_TAG_LENGTH)), decipher.final()]).toString("utf8")
  } catch {
    return null
  }
}
