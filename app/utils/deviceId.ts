...
/**
 * A deviceId looks like `23-Xk29vBq7mTz4LpR8nWc1s-7QF3KMBH`:
 *
 ...
 * check, typing `23-whatever` there was enough to invent visitors or write rows under someone
...
const DEVICE_ID_PATTERN = /^23-([0-9a-zA-Z]{21})-([0-9ABCDEFGHJKMNPQRSTVWXYZ]{8})$/
 ...
 * `23-<21 chars>-<8 chars>`, and you know what the server expects. So every character steps 3
