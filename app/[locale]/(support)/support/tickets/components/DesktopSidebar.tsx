...
export function DesktopSidebar({ onOpenTicket, tickets, ticketsAmount, unreadMessages }: DesktopSidebarProps) {
  return (
    <aside className="hidden h-full w-[320px] shrink-0 laptop:flex">
      <div className="flex h-full w-full flex-col overflow-hidden rounded-md border border-border-color/35 bg-foreground/5">
