...
export function UTMTracker() {
  useEffect(() => {
    ...
    function stripUTMParamsFromUrl() {
      ...
      window.history.replaceState({}, "", window.location.origin + window.location.pathname + (search ? `?${search}` : ""))
    }
    ...
    trackVisit()
      .catch(error => console.log(46, "UTMTracker trackVisitAction failed - no utm_stats row for this visit \n", error))
