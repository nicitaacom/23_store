...
export default async function SupportPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-64px)] w-full max-w-5xl flex-col justify-center gap-6 px-4 py-10">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-title tablet:text-4xl">{getI18nResp("support.title")}</h1>
        <p className="mt-2 text-base text-subTitle">{getI18nResp("support.subtitle")}</p>
      </div>
      ...
      <div className="grid gap-3 tablet:grid-cols-3">
        <div className="flex flex-col gap-3 rounded-lg border border-border-color/35 bg-foreground/35 p-4 transition-colors duration-150 hover:border-brand/30">
          ...
          <h2 className="text-base font-semibold text-title">{getI18nResp("support.option_1")}</h2>
        ...
        <div className="flex flex-col gap-3 rounded-lg border border-border-color/35 bg-foreground/35 p-4 transition-colors duration-150 hover:border-brand/30">
          ...
          <h2 className="text-base font-semibold text-title">{getI18nResp("support.option_2_title")}</h2>
          <p className="text-xs text-subTitle">{getI18nResp("support.option_2_subtitle")}</p>
        ...
        <div className="flex flex-col gap-3 rounded-lg border border-border-color/35 bg-foreground/35 p-4 transition-colors duration-150 hover:border-brand/30">
          ...
          <h2 className="text-base font-semibold text-title">{getI18nResp("support.option_3")}</h2>
          <Button className="mt-auto" variant="default-outline" href={process.env.NEXT_PUBLIC_TELEGRAM_URL} target="_blank">
            {getI18nResp("support.open_telegram")}
          </Button>
        </div>
      </div>
    </div>
