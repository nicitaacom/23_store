  ...
  return (
    <div className="w-full overflow-y-auto">
      ...
      <motion.div
        ...
        <div className="flex flex-col mobile:flex-row mobile:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg mobile:text-xl font-bold text-title">Total Campaign Clicks</h2>
              <p className="text-subTitle text-sm mobile:text-base">Across all sources</p>
            </div>
          </div>
      ...
      <div className="mb-4 tablet:mb-6">
        <h3 className="text-xl mobile:text-2xl font-bold text-title mb-3 tablet:mb-4">Traffic Distribution</h3>
          ...
          return (
            <motion.div
              ...
              <div className="flex justify-between items-start mb-3 tablet:mb-4">
                ...
                <span className="text-subTitle text-xs tablet:text-sm">
