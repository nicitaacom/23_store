...
export default {
  ...
  "backup.import_partial": "Backup imported with unresolved images",
  "backup.relink_result": "{count} image URL(s) relinked to this database",
  "backup.unresolved_result": "{references} image URL(s) unresolved because {paths} file path(s) are missing",
  "backup.relink_table_result": "{updated} relinked, {unresolved} unresolved",
  ...
  "common.something_went_wrong": "This page failed to render. Please try again or contact support if it continues.",
  "common.try_again": "Try again",
  "common.report_to_support": "Report to support",
  "common.reporting_to_support": "Sending report...",
  ...
  "payment.error.sending_money_with_solana": "Error in sendMoneyWithSolana:",
  "payment.error.phantom_not_detected": "Phantom not detected",
  "payment.error.please_install_phantom": "Please install phantom",
  "payment.error.or_enable_phantom": "or enable phantom extension. Already done it?",
  "payment.error.you_rejected_connection": "You rejected connection",
