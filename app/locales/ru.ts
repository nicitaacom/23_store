...
export default {
  ...
  "backup.import_partial": "Копия импортирована, но часть изображений не найдена",
  "backup.relink_result": "Ссылок на изображения привязано к этой базе: {count}",
  "backup.unresolved_result": "Не удалось привязать ссылок: {references}; отсутствующих путей к файлам: {paths}",
  "backup.relink_table_result": "Привязано: {updated}, не найдено: {unresolved}",
