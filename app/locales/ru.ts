...
export default {
  ...
  "backup.subtitle": "Экспортируйте все таблицы 23_ в файл .tar.gz или импортируйте предыдущую копию.",
  "backup.export_title": "Экспорт",
  "backup.export_subtitle": "Скачайте снимок всех таблиц и файлов хранилища в виде файла .tar.gz.",
  "backup.export_button": "Скачать копию",
  "backup.export_split": "Копия большая, поэтому разбита на два файла (front + back). Сохраните оба.",
  "backup.export_progress": "Скачивание копии",
  "backup.import_title": "Импорт",
  "backup.import_subtitle": "Загрузите .tar.gz (обе части, если разбито), чтобы восстановить строки и файлы (существующие заменяются).",
  "backup.import_button": "Загрузить копию",
  "backup.import_progress": "Загрузка копии",
  ...
  "category.backfill_button": "Назначить категории {count} товарам",
