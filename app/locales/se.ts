...
export default {
  ...
  "backup.subtitle": "Exportera alla 23_-tabeller till en .tar.gz-fil eller importera en tidigare kopia.",
  "backup.export_title": "Export",
  "backup.export_subtitle": "Ladda ner en ögonblicksbild av alla tabeller och lagringsfiler som en .tar.gz-fil.",
  "backup.export_button": "Ladda ner kopia",
  "backup.export_split": "Kopian var stor, så den delades i två filer (front + back). Behåll båda.",
  "backup.export_progress": "Laddar ner kopia",
  "backup.import_title": "Import",
  "backup.import_subtitle": "Ladda upp din .tar.gz-kopia (båda delarna om delad) för att återställa rader och filer (befintliga ersätts).",
  "backup.import_button": "Ladda upp kopia",
  "backup.import_progress": "Laddar upp kopia",
  ...
  "category.backfill_button": "Tilldela kategorier till {count} produkter",
