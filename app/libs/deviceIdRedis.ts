 ...
 *
 *   utm:23:device-id:by-user-id:<account uuid>  -> deviceId, expiring 30 days after the last visit
 *   utm:23:device-id:owner:<deviceId>           -> account uuid, same 30 days
 *   utm:23:device-id:by-ip:<ip>                 -> deviceId, expiring at midnight in the visitor's timezone
 *   utm:23:device-id:by-fingerprint:<sha256>    -> deviceId, expiring 10 minutes after it was written
 *
 ...
 *
 * `23` is in every key because projects 14/19/23/28/29 share one Upstash database. Without it all
 ...
 */
const PROJECT_KEY_PREFIX = "utm:23:device-id"
