  ...
  outline-none disabled:opacity-50 disabled:pointer-events-none transparent-colors duration-300`,
  {
    variants: {
      variant: {
        ...
        "continue-with": "p-4 w-full font-secondary text-subTitle bg-border-color flex justify-center items-center gap-x-4",
      },
      active: {
