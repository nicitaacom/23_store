...
export function RadioButton({ label, inputName, onChange, ...props }: RadioButton) {
  return (
    <label htmlFor={label} className="relative cursor-pointer flex items-center justify-center mt-2 tablet:mt-0 px-4 py-2
    transition-all duration-300">
      ...
      <span
        ...
        peer-checked:before:border-cta peer-checked:before:border-b-2
        `}
      />
      {label}
    </label>
