...
return (
    <section className="absolute left-[50%] top-[50%] translate-x-[-50%]
    ...
    flex flex-col text-center justify-center items-center w-full">
      ...
      <>
        ...
        <p className="flex flex-row">Redirecting to home page in <Timer seconds={5} action={() => navigate('/',{replace:true})}/></p>
        </>
        :
        <>
