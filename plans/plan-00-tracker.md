...
| 18 | [plan-18-solana-payments.md](plan-18-solana-payments.md) | P1 | Sonnet · medium | waiting - all 7 decisions made (all A: direct window.solana, devnet, public RPC, no server verification, NEXT_PUBLIC_SOLANA_ADDRESS, SOL only, CMC USD->SOL amount conversion); ready for the implementing chat | — |
